...
export const TagsInputControl = React.forwardRef<HTMLDivElement, TagsInputControlProps>(
...
export const TagsInputItem = React.forwardRef<HTMLDivElement, ChakraTagsInput.ItemProps>(
...
export const TagsInputRoot = React.forwardRef<HTMLDivElement, ChakraTagsInput.RootProps>(
